This ansible script also requires the installation of an additional module which can be done with: 
...
ssh-copy-id loud@192.168.100.5
...
ansible-playbook apollo.yml --user loud
